...
class RVX_Builder_Module_Woocommerce_Tabs extends \ET_Builder_Module_Tabs
{
    ...
    public function get_fields()
    {
        return \array_merge(parent::get_fields(), [
            ...
            'rvx_template_fallback_color' => array('label' => esc_html__('Avater Fallback Color', 'reviewx'), 'description' => esc_html__('', 'reviewx'), 'type' => 'color-alpha', 'custom_color' => \true, 'tab_slug' => 'advanced', 'toggle_slug' => 'rvx_review_item', 'hover' => 'tabs', 'mobile_options' => \true, 'sticky' => \true),
            //Form
            ...
            'rvx_review_form_avatar_height' => array('label' => esc_html__('Product Size Height', 'reviewx'), 'description' => esc_html__('', 'reviewx'), 'type' => 'range', 'tab_slug' => 'advanced', 'option_category' => 'layout', 'default' => '50px', 'unitless' => \false, 'units' => array('px', '%', 'em', 'rem'), 'range_settings' => array('min' => '50', 'max' => '1000', 'step' => '10'), 'toggle_slug' => 'rvx_review_form'),
            'rvx_review_form_avatar_width' => array('label' => esc_html__('Product  Width', 'reviewx'), 'description' => esc_html__('', 'reviewx'), 'type' => 'range', 'tab_slug' => 'advanced', 'option_category' => 'layout', 'default' => '50px', 'unitless' => \false, 'units' => array('px', '%', 'em', 'rem'), 'range_settings' => array('min' => '50', 'max' => '1000', 'step' => '10'), 'toggle_slug' => 'rvx_review_form'),
            'rvx_review_form_font_size' => array('label' => esc_html__('Font Size', 'reviewx'), 'description' => esc_html__('', 'reviewx'), 'type' => 'range', 'tab_slug' => 'advanced', 'option_category' => 'layout', 'default' => '16px', 'unitless' => \false, 'units' => array('px', '%', 'em', 'rem'), 'range_settings' => array('min' => '10', 'max' => '1000', 'step' => '10'), 'toggle_slug' => 'rvx_review_form'),
    ...
    {
        // Get tabs data.
        $this->rendered_tabs_data = self::get_tabs(array('product' => $this->props['product'], 'include_tabs' => $this->props['include_tabs']));
