 ...
 * @since 2.0
 */
\class_alias('Rvx\\RVX_Oxygen_Summary', 'RVX_Oxygen_Summary', \false);
// Create component instance
global $oxygen_vsb_components;
$oxygen_vsb_components['rvx_summary'] = new RVX_Oxygen_Summary(array('name' => __('ReviewX Summary', 'reviewx'), 'tag' => 'oxy_rvx_summary', 'params' => array(array("param_name" => "product_id", "value" => "", "type" => "textfield", "heading" => __("Product Id", "reviewx"), "css" => \false)), 'advanced' => array("positioning" => array("values" => array('width' => '100', 'width-unit' => '%')), "other" => array("values" => array('product_id' => ""))), 'not_css_params' => array('product_id')));
