 ...
 * @since 2.0
 */
\class_alias('Rvx\\RVX_Oxygen_Stats', 'RVX_Oxygen_Stats', \false);
// Create component instance
global $oxygen_vsb_components;
$oxygen_vsb_components['rvx_stats'] = new RVX_Oxygen_Stats(array('name' => __('ReviewX Stats', 'reviewx'), 'tag' => 'oxy_rvx_stats', 'params' => array(array("param_name" => "product_id", "value" => "", "type" => "textfield", "heading" => __("Product Id", "reviewx"), "css" => \false)), 'advanced' => array("positioning" => array("values" => array('width' => '100', 'width-unit' => '%')), "other" => array("values" => array('product_id' => ""))), 'not_css_params' => array('product_id')));
