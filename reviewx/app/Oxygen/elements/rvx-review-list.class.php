 ...
 * @since 2.0
 */
class RVX_Oxygen_Review_List extends CT_Component
{
    public $param_array;
    public $css_util;
    public $query;
    ...
    function add_shortcode($atts, $content, $name)
    {
        ...
        echo do_shortcode("[rvx-review-list product_id='" . $atts['product_id'] . "']");
    }
 ...
 * @since 2.0
 */
\class_alias('Rvx\\RVX_Oxygen_Review_List', 'RVX_Oxygen_Review_List', \false);
// Create component instance
global $oxygen_vsb_components;
$oxygen_vsb_components['rvx_review_list'] = new RVX_Oxygen_Review_List(array('name' => __('ReviewX Review List', 'reviewx'), 'tag' => 'oxy_rvx_review_list', 'params' => array(array("param_name" => "product_id", "value" => "", "type" => "textfield", "heading" => __("Product Id", "reviewx"), "css" => \false)), 'advanced' => array("positioning" => array("values" => array('width' => '100', 'width-unit' => '%')), "other" => array("values" => array('product_id' => ""))), 'not_css_params' => array('product_id')));
