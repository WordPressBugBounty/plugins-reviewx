...
class Cpt_Widgets extends Widget_Base
{
    ...
    public function graph()
    {
        ...
        $this->add_control('rx_template_summary_criteria_star_color', ['label' => \esc_html__('Summary Criteria Star Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#FBD045', 'selectors' => ['   #rvx-storefront-widget .rvx-aggregation-multicriteria__total .rvx-aggregation-multicriteria__start-icon path' => 'fill: {{VALUE}} !important']]);
        $this->add_control('rx_template_aggeregation_criteria_progressbar_color', ['label' => \esc_html__('Aggregation Multicriteria Bar', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#FBD045', 'selectors' => ['   #rvx-storefront-widget .rvx-aggregation__progressbar .rvx-aggregation__progressbar-active' => 'background: {{VALUE}} !important']]);
        $this->add_control('rx_template_progressbar_active_color', ['label' => \esc_html__('Progressbar Active Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#FBD045', 'selectors' => ['   #rvx-storefront-widget .rvx-aggregation__progressbar .rvx-aggregation__progressbar-active' => 'background: {{VALUE}} !important']]);
        $this->add_control('rx_template_total_review_color', ['label' => \esc_html__('Total Reviews Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#717C71', 'selectors' => ['   #rvx-storefront-widget .rvx-total-review' => 'color: {{VALUE}} !important']]);
