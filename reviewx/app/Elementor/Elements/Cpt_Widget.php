...
class Cpt_Widgets extends Widget_Base
{
    ...
    public function graph()
    {
        ...
        $this->add_control('rx_template_badget_color', ['label' => __('Badget Background Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#5FC65F', 'selectors' => ['  #rvx-storefront-widget .rvx-rating-badge' => 'background-color: {{VALUE}} !important']]);
        $this->add_control('rx_template_text_color', ['label' => __('Badget Text Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#FFFFFF', 'selectors' => ['   #rvx-storefront-widget .rvx-rating-badge__text' => 'color: {{VALUE}} !important']]);
