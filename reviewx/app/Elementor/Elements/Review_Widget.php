...
class Review_Widget extends Widget_Base
{
    ...
    public function graph()
    {
        ...
        $this->add_control('rvx_template_max_rating_color', ['label' => \esc_html__('Max Rating Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#BDBDBD', 'selectors' => ['{{WRAPPER}} #rvx-storefront-widget .rvx-max-rating' => 'color: {{VALUE}} !important']]);
        $this->add_control('rvx_template_badge_color', ['label' => \esc_html__('Badge Background Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#4CAF50', 'selectors' => ['.woocommerce {{WRAPPER}} #rvx-storefront-widget .rvx-rating-badge' => 'background-color: {{VALUE}} !important']]);
    ...
    public function frontSize()
    {
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'rvx_title_value_typography', 'label' => \esc_html__('Title Value', 'reviewx'), 'selector' => '.woocommerce {{WRAPPER}} .rvx-review-info .rvx-review-info__title']);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'rvx_description_label_typography', 'label' => \esc_html__('Description label', 'reviewx'), 'selector' => '.woocommerce {{WRAPPER}} .rvx-review-form__description .rvx-review-form__title--name']);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'rvx_description_value_typography', 'label' => \esc_html__('Description Value', 'reviewx'), 'selector' => '.woocommerce {{WRAPPER}} .rvx-review-info .rvx-review-info__feedback']);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'rvx_attachments_typography', 'label' => \esc_html__('Attachment', 'reviewx'), 'selector' => '.woocommerce {{WRAPPER}} .rvx-review-form__attachment--name']);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'rvx_recommended_typography', 'label' => \esc_html__('Recommended', 'reviewx'), 'selector' => '.woocommerce {{WRAPPER}} .rvx-review-form__recommended--name']);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'rvx_anonymous_typography', 'label' => \esc_html__('Mark as Anonymous', 'reviewx'), 'selector' => '.woocommerce {{WRAPPER}} .rvx-review-form__mark-anonymous']);
        $this->end_controls_tabs();
        $this->end_controls_section();
    }
    /**
