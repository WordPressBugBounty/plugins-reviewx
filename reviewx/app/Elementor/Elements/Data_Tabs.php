...
class Data_Tabs extends Widget_Base
{
    ...
    public function graph()
    {
        ...
        $this->add_control('rvx_template_max_rating_color', ['label' => \esc_html__('Max Rating Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#BDBDBD', 'selectors' => ['{{WRAPPER}} .woocommerce-Tabs-panel #rvx-storefront-widget .rvx-max-rating' => 'color: {{VALUE}} !important']]);
        $this->add_control('rvx_template_badge_color', ['label' => \esc_html__('Badge Background Color', 'reviewx'), 'type' => Controls_Manager::COLOR, 'default' => '#4CAF50', 'selectors' => ['.woocommerce {{WRAPPER}} .woocommerce-Tabs-panel #rvx-storefront-widget .rvx-rating-badge' => 'background-color: {{VALUE}} !important']]);
