...
class ProductUntrashHandler
{
    ...
    {
        $productUniqueId = Client::getUid() . '-' . $product_id;
        // error_log("res123 >>>>> ". print_r($productUniqueId, true));
        $response = (new ProductApi())->trashToRestoreWpProduct($productUniqueId);
        // error_log("res123 >>>>> ". print_r($response, true));
